...
@pytest.mark.anyio
async def test_get_copilot_token_token_exchange(monkeypatch):
...
@pytest.mark.anyio
async def test_get_copilot_token_unexpired_access(monkeypatch):
    monkeypatch.delenv("COPILOT_OAUTH_TOKEN", raising=False)
    fake_data = {
...
@pytest.mark.anyio
async def test_get_copilot_token_expired_access_goes_to_exchange(monkeypatch):
    monkeypatch.delenv("COPILOT_OAUTH_TOKEN", raising=False)
    fake_data = {
